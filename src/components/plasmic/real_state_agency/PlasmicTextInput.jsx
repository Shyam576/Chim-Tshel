...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 9ishsuNJ_m8j/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: L8awm4zQldl3/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: vUEqujdevrQW/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__teJh)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__wo7X1)}
              role={"img"}
            />
          ),
